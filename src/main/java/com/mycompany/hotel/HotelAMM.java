...
import com.mycompany.hotel.objetos.ClienteAMM;
import com.mycompany.hotel.objetos.EmpleadoAMM;
import com.mycompany.hotel.objetos.HabitacionAMM;
import java.util.ArrayList;
import java.util.Scanner;

public class HotelAMM {

    public static void main(String[] args) {
        Scanner teclado = new Scanner(System.in);
        ArrayList<ClienteAMM> clientes = new ArrayList<ClienteAMM>();
        ArrayList<EmpleadoAMM> empleados = new ArrayList<EmpleadoAMM>();
        ArrayList<HabitacionAMM> habitaciones = new ArrayList<HabitacionAMM>();

        ClienteAMM cliente = null;
        EmpleadoAMM empleado = null;
        HabitacionAMM habitación = null;
        int idCliente;
        int idEmpleado;
        String nombre;
        String apellidos;
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    cliente = new ClienteAMM(idCliente);
                    teclado.nextLine();
                ...
                case 2:
                    ...
                    if (clientes.isEmpty()) {
                        ...
                        for (ClienteAMM clienteABorrar : clientes) {
                ...
                case 3:
                    ...
                    empleado = new EmpleadoAMM(idEmpleado);
                    teclado.nextLine();
                ...
                case 4:
                    ...
                    if (empleados.isEmpty()) {
                        ...
                        for (EmpleadoAMM clienteABorrar : empleados) {
                ...
                case 5:
                    ...
                    habitación = new HabitacionAMM(idHabitacion);
                    teclado.nextLine();
                ...
                case 6:
                    ...
                    if (habitaciones.isEmpty()) {
                        ...
                        for (HabitacionAMM clienteABorrar : habitaciones) {
                ...
                case 7:
                    if (clientes.isEmpty()) {
                        ...
                        for (ClienteAMM clienteAMostrar : clientes) {
                ...
                case 8:
                    if (empleados.isEmpty()) {
                        ...
                        for (EmpleadoAMM empleadoAMostrar : empleados) {
                ...
                case 9:
                    if (habitaciones.isEmpty()) {
                        ...
                        for (HabitacionAMM claseAMostrar : habitaciones) {
